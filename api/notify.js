export default async function handler(req, res) {
    ...
    try {
        ...
        if (type === "size_guide") {
            ...
            aiMessage = `أهلاً يا دكتور، مع حضرتك فريق Pioneer للملابس الطبية 👨‍⚕️\n` + 
                        `لاحظنا إنك طلبت كود الخصم (DOCTOR5).. حابين نأكدلك إن الكود شغال وتقدر تستخدمه، لو واجهتك أي مشكلة في الموقع أو محتاج مساعدة في اختيار المقاس إحنا معاك وتحت أمرك.`;
        }
